...
public class TutorialUpload extends AppCompatActivity {
    SharedPreferences s;
    String u_name;
    String user_email;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        web1.loadUrl("http://studyforfun.000webhostapp.com/tutorial_upload.php?name="+u_name+"&"+"email="+user_email);
        ...
        web1.setWebChromeClient(new WebChromeClient() {
            public boolean onShowFileChooser(
                ...
                if (takePictureIntent.resolveActivity(TutorialUpload.this.getPackageManager()) != null) {
                    File photoFile = null;
                    try {
